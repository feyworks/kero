...
impl GameBuilder {
    pub fn new() -> Result<Self, GameError> {
        ...
        let this = {
            ...
            this //
                .with_module::<kero_color::ColorModule>()?
                .with_module::<kero_guid::GuidModule>()?
                .with_module::<kero_img::ImageModule>()?
                .with_module::<kero_lua::InstantModule>()?
                .with_modules::<kero_math::MathModules>()?
                .with_module::<kero_rand::RandModule>()?
