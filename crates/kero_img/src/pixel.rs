...
use kero_color::{Channel, Grey, GreyAlpha, Rgb, Rgba};
use std::fmt::Debug;
...
mod private {
    ...
    impl<T> Sealed for kero_color::Grey<T> {}
    impl<T> Sealed for kero_color::GreyAlpha<T> {}
    impl<T> Sealed for kero_color::Rgb<T> {}
    impl<T> Sealed for kero_color::Rgba<T> {}
}
